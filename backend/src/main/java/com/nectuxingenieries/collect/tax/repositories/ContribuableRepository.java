...
//
    ...
    @Query("SELECT COUNT(c) FROM Contribuable c WHERE c.createdAt >= :start AND c.createdAt <= :end")
    ...
    Optional<Contribuable> findActiveByTelephone(@Param("telephone") String telephone);
}
