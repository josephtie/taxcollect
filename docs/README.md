# TaxCollect - Documentation Technique

Ce dossier contient la documentation technique du projet TaxCollect.
...
### Corrections & Analyses
- [Fix CORS](CORS_FIX_INSTRUCTIONS.md)
- [Corrections des endpoints](ENDPOINTS_CORRECTIONS_SUMMARY.md)
- [Analyse des mismatches endpoints](ENDPOINTS_MISMATCH_ANALYSIS.md)
- [Analyse de la synchronisation](SYNCHRONISATION_ANALYSIS.md)
- [Corrections de la synchronisation](SYNCHRONISATION_CORRECTIONS.md)

### Tests
- [Checklist de test rapide](QUICK_TEST_CHECKLIST.md)
- [Plan de flux de test](TEST_FLOW_PLAN.md)
